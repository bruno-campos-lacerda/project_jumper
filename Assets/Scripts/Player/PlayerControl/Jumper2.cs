...
public class Jumper2 : MonoBehaviour {
    ...
    void Start() {
        ...
        highCount.text = PlayerPrefs.GetInt("HighScore2P").ToString();
        highScore = PlayerPrefs.GetInt("HighScore2P");
    }
    ...
    void Update() {
        ...
        float move = jumper.Player2.Movement.ReadValue<float>() * speed;
        float jump = jumper.Player2.Jump.ReadValue<float>();
        ...
        PlayerPrefs.SetInt("HighScore2P", highScore);
